                        ...
                        @forelse ($countries as $country)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button wire:click="deleteCountry({{ $country->id }})" class="btn btn-danger" onclick="confirm('Are you sure?');">Delete</button>
                                </td>
                            </tr>
                        @empty
                            <tr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="country_code" type="text"
                                        class="form-control @error('country_code') is-invalid @enderror" wire:model.defer="country_code">
